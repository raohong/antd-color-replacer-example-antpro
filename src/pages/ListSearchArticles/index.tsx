...
interface ListSearchArticlesProps extends FormComponentProps {
  dispatch: Dispatch<any>;
  listSearchArticles: StateType;
  loading: boolean;
}

class ListSearchArticles extends Component<ListSearchArticlesProps> {
  componentDidMount() {
...
const WarpForm = Form.create<ListSearchArticlesProps>({
  onValuesChange({ dispatch }: ListSearchArticlesProps) {
    // 表单项变化时请求数据
    // 模拟查询表单生效
    dispatch({
      type: 'listSearchArticles/fetch',
